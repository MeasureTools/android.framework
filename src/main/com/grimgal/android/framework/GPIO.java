...
package com.grimgal.android.framework;
...
public class GPIO {
	...
	protected GPIO(int number) {
		com.grimgal.android.framework.Log.v("GPIO["+this.number+"]", "INIT");
		this.number = number;
	}
	...
	public boolean getValue() {
		try {
			...
			com.grimgal.android.framework.Log.v("GPIO["+this.number+"]", "GET: " + value);
			return value;
		}
		catch (RemoteException e) {
	...
	public void setValue(boolean value) {
		try {
			com.grimgal.android.framework.Log.v("GPIO["+this.number+"]", "SET: " + value);
